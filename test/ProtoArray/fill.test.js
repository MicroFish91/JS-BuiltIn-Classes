...
module.exports = function() {
  describe('ProtoArray .fill()', function(){
    ...
    it('Fill operates with three params', function() {
      ...
      expect(result).to.eql({ length: 3, values: { 0: 1, 1: 4, 2: 3 } });
      expect(result2).to.eql({ length: 3, values: { 0: 1, 1: 2, 2: 3 } });
      expect(result3).to.eql({ length: 3, values: { 0: 1, 1: 2, 2: 3 } });
      expect(result4).to.eql({ length: 3, values: { 0: 4, 1: 2, 2: 3 } });
      expect(result5).to.eql({ length: 3, values: { 0: 1, 1: 2, 2: 3 } });
      expect(result6).to.eql({ length: 3, values: { 0: 1, 1: 2, 2: 3 } });
      expect(result6).to.eql({ length: 3, values: { 0: 1, 1: 2, 2: 3 } });
    });
  }); // End describe
